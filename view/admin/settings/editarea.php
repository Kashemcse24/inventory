    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-4">
          ...
          <form action="view/admin/settings/updatearea.php"  method="POST" enctype="multipart/form-data" >
              <!-- Page Title -->
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="area_name" value="<?= $areas['area_name']?>" required="1">
                </div>
              </div>
